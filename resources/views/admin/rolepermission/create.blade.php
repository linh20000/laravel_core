                            ...
                            <div class="row">
                                @foreach($permissions as $permission)
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="permission[]"  value="{{ !empty($permission->name) ? $permission->name : '' }}" {{ isset($rolePermissionArr[$permission->id]['id']) == $permission->id ? 'checked' : '' }} > {{ translate($permission->name) }}
                                            </label>
                                        </div>
                                    </div>
                                @endforeach
