                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" style="width: 100%;" name="status">
                            ...
                            @if(isset($demo))
                            <option class="text-black font-medium" value="{{$data['value']}}" {{$demo->status ==
                                $data['value'] ? 'selected' : ''}}>
                                {{$data['name']}}
                            </option>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" style="width: 100%;" name="label">
                            ...
                            @if(isset($demo))
                            <option class="text-black font-medium" value="{{$data}}" {{$demo->label ==
                                $data ? 'selected' : ''}}>
                                {{$data}}
                            </option>
                            @else
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="seo_description" value="{{isset($demo) ? $demo->seo_description : ''}}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="seo_canonical" value="{{isset($demo) ? $demo->seo_canonical : ''}}"
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        @if(isset($demo) == true)
                        <img src="{{asset($demo->thumbnail)}}" style="width:100%" class="img-fluid" alt="" />
                        @else
