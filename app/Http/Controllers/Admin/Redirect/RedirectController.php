...
class RedirectController extends Controller
{
    ...
    {
        if(\Auth::user()->hasPermissionTo('list redirect')) {
    ...
    {
        if(\Auth::user()->hasPermissionTo('add redirect')) {
    ...
    {
        if(\Auth::user()->hasPermissionTo('delete redirect')) {
    ...
    {
        if(\Auth::user()->hasPermissionTo('edit redirect')) {
